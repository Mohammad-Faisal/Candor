...
public class ReportFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks,
        ...
        reportSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedImageUri!=null){
                    ...
                    final ProgressDialog dialog = ProgressDialog.show(getActivity(), "Submitting your report", "Please wait...", true);
                    dialog.show();
    ...
    private void sendMessage() {
        ...
        Thread sender = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    GmailSender sender = new GmailSender("candorappbd@gmail.com", "plan2018");
                    sender.sendMail("Report from Candor app BD",
                            "Here is a problem !",
                            "youremail",
