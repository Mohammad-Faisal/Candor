...
public class Posts {
    ...
    public Posts(String uid, String time_and_date, String caption, String post_image_url, String thumbs_up_cnt, String  location , String post_push_id , int time_stamp) {
