...
public class StartingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		playButton.getLayoutParams().width=(getDeviceWidth()*3)/5;
		playButton.getLayoutParams().height=(getDeviceHeight()*3)/5;
	...
	public int getDeviceWidth(){
		return (int) getResources().getDisplayMetrics().widthPixels;  // displayMetrics.density;
	}
