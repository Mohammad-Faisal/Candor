...
public class ChatActivity extends AppCompatActivity {
        ...
        mCurrentUserDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ChatActivity.this).load(currentUserThumbImage).networkPolicy(NetworkPolicy.OFFLINE)
                        .placeholder(R.drawable.blank_profile).into(mImageIconTop, new Callback() {
                    @Override
                    ...
                    @Override
                    public void onError(){
                        Picasso.with(ChatActivity.this).load(currentUserThumbImage).placeholder(R.drawable.blank_profile).into(mImageIconTop);
                    }
                });
    ...
    //send button press korle ja hobe
